...
#define BUILDER_APPEND_IF_DIFF(BUILDER, CCSTRING, CHARS) \
    __android_log_print(ANDROID_LOG_DEBUG, "StarNameIn C", "StarName5"); \
    if (NULL != BUILDER && NULL != CCSTRING && 0 != strcmp(CCSTRING, CHARS)) { \
        __android_log_print(ANDROID_LOG_DEBUG, "StarNameIn C", "StarName6");   \
        emptyBuilder(env, BUILDER);                      \
        __android_log_print(ANDROID_LOG_DEBUG, "StarNameIn C", "StarName7");   \
...
/*
 * void azalt(double tjd_ut,int32 calc_flag,double *geopos,double atpress,double attemp,double *xin)
 *
 * Class:     swelib_SwissEph
 * Method:    azalt
 * Signature: (DI[DDD[D)[D
 */
JNIEXPORT jdoubleArray JNICALL
Java_com_example_swelib_SwissEph_azalt(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint calc_flag,
                                       jdoubleArray geoposArray, jdouble atpress, jdouble attemp,
                                       jdoubleArray xinArray) {
    ...
    jdoubleArray jxaz = (*env)->NewDoubleArray(env,3);
    (*env)->SetDoubleArrayRegion(env, jxaz,0,3,xaz);
    return jxaz;
}
...
Java_com_example_swelib_SwissEph_azalt_1rev(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint calc_flag,
...
Java_com_example_swelib_SwissEph_heliacal_1ut(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_heliacal_1pheno_1ut(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_vis_1limit_1mag(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_heliacal_1angle(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_topo_1arcus_1visionis(JNIEnv *env, jclass swisseph,
                                                  jdouble tjdut, jdoubleArray dgeoArray,
                                                  jdoubleArray datmArray, jdoubleArray dobsArray,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1astro_1models(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_get_1astro_1models(JNIEnv *env, jclass swisseph,
...
Java_com_example_swelib_SwissEph_version(JNIEnv *env, jclass swisseph) {
    char s[AS_MAXCH];
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_example_swelib_SwissEph_get_1library_1path(JNIEnv *env, jclass swisseph) {
    char s[AS_MAXCH];
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_calc(JNIEnv *env, jclass swisseph, jdouble tjd, jint ipl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_calc_1ut(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint ipl,
                                     jint iflag, jdoubleArray xxArray, jobject errBuilder) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_calc_1pctr(JNIEnv *env, jclass swisseph, jdouble tjd, jint ipl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_fixstar(JNIEnv *env, jclass swisseph, jobject starNameBuilder, jdouble tjd,
                                    jint iflag, jdoubleArray xxArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
 ...
 * Signature: (Ljava/lang/StringBuilder;DI[DLjava/lang/StringBuilder;)I
 */
jint Java_com_example_swelib_SwissEph_fixstar_1ut(JNIEnv *env, jclass swisseph, jobject starNameBuilder, jdouble tjd_ut,
                                        jint iflag, jdoubleArray xxArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isDblCopy, xxArray, xx)
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "StarNameIn C", "StarName1: %s", star_name);
    BUILDER_APPEND_IF_DIFF(starNameBuilder, starname, star_name)
    __android_log_print(ANDROID_LOG_DEBUG, "StarNameIn C", "StarName2");
    RLZ_DOUBLE_ARRAY_ELEMENTS(isDblCopy, xxArray, xx)
    __android_log_print(ANDROID_LOG_DEBUG, "StarNameIn C", "StarName3");
    RLZ_STRING_UTF_CHARS(isCopy, starName, starname)
    __android_log_print(ANDROID_LOG_DEBUG, "StarNameIn C", "StarName4");
    ERR_BUILDER_APPEND_IF_ERR
    __android_log_print(ANDROID_LOG_DEBUG, "StarNameIn C", "StarName5");
    return retc;
}
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_fixstar_1mag(JNIEnv *env, jclass swisseph, jobject starNameBuilder,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_fixstar2(JNIEnv *env, jclass swisseph, jobject starNameBuilder, jdouble tjd,
                                     jint iflag, jdoubleArray xxArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isDblCopy, xxArray, xx)
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_fixstar2_1ut(JNIEnv *env, jclass swisseph, jobject starNameBuilder, jdouble tjd_ut,
                                         jint iflag, jdoubleArray xxArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isDblCopy, xxArray, xx)
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_fixstar2_1mag(JNIEnv *env, jclass swisseph, jobject starNameBuilder,
                                          jdoubleArray magArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isDblCopy, magArray, mag)
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_close(JNIEnv *env, jclass swisseph) {
    swe_close();
}
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1ephe_1path(JNIEnv *env, jclass swisseph, jstring jEphePath) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1jpl_1file(JNIEnv *env, jclass swisseph, jstring jplPath) {
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_example_swelib_SwissEph_get_1planet_1name(JNIEnv *env, jclass swisseph, jint ipl) {
    char s[AS_MAXCH];
    jstring result = NULL;
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1topo(JNIEnv *env, jclass swisseph, jdouble geolon, jdouble geolat, jdouble geoalt) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1sid_1mode(JNIEnv *env, jclass swisseph, jint sid_mode, jdouble t0, jdouble ayan_t0) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_get_1ayanamsa_1ex(JNIEnv *env, jclass swisseph, jdouble tjd_et, jint iflag,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_get_1ayanamsa_1ex_1ut(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint iflag,
                                                  jdoubleArray dayaArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isCopy, dayaArray, daya)
...
Java_com_example_swelib_SwissEph_get_1ayanamsa(JNIEnv *env, jclass swisseph, jdouble tjd_et) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_get_1ayanamsa_1ut(JNIEnv *env, jclass swisseph, jdouble tjd_ut) {
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_example_swelib_SwissEph_get_1ayanamsa_1name(JNIEnv *env, jclass swisseph, jint isidmode) {
    jstring result = NULL;
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_example_swelib_SwissEph_get_1current_1file_1data(JNIEnv *env, jclass swisseph, jint ifno,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_date_1conversion(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_julday(JNIEnv *env, jclass swisseph,
...
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_solcross_1ut(JNIEnv *env, jclass swisseph,
                                                         jdouble x2cross, jdouble jd_ut, jint flag, jobject errBuilder) {
    DEFINE_CHAR_SERR
    double retc = swe_solcross_ut(x2cross, jd_ut, flag, serr);
    ERR_BUILDER_APPEND_IF_ERR
    return retc;
}
//get 12 JieQi for BaZi
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_solcross_1ut_1jieqi_1list_1bazi(JNIEnv *env, jclass swisseph,
                                                               jdoubleArray x12, jint year, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(IS_COPY, x12, jieqiList)
    double jd_ut = swe_julday(year,1,1,0.0,1);

    for(int i = 0; i<12;i++){
        jieqiList[i] = swe_solcross_ut((315+i*30)%360, jd_ut, 256, serr);
        jd_ut = jieqiList[i]+20;
    }
    RLZ_DOUBLE_ARRAY_ELEMENTS_OK(IS_COPY, x12, jieqiList)
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_revjul(JNIEnv *env, jclass swisseph, jdouble jd,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_utc_1to_1jd(JNIEnv *env, jclass swisseph, jint iyear, jint imonth,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_jdet_1to_1utc(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_jdut1_1to_1utc(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_utc_1time_1zone(JNIEnv *env, jclass swisseph, jint iyear, jint imonth,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_houses(JNIEnv *env, jclass swisseph, jdouble tjd_ut,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_houses_1ex(JNIEnv *env, jclass swisseph, jdouble tjd_ut,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_houses_1ex2(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_houses_1armc(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_houses_1armc_1ex2(JNIEnv *env, jclass swisseph, jdouble armc, jdouble geolat,
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_house_1pos(JNIEnv *env, jclass swisseph, jdouble armc, jdouble geolat,
 ...
 */
JNIEXPORT jstring JNICALL
Java_com_example_swelib_SwissEph_house_1name(JNIEnv *env, jclass swisseph, jint hsys) {
    jstring result = NULL;
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_gauquelin_1sector(JNIEnv *env, jclass swisseph, jdouble t_ut, jint ipl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_sol_1eclipse_1where(JNIEnv *env, jclass swisseph, jdouble tjd, jint ifl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_lun_1occult_1where(JNIEnv *env, jclass swisseph, jdouble tjd, jint ipl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_sol_1eclipse_1how(JNIEnv *env, jclass swisseph, jdouble tjd, jint ifl,
                                              jdoubleArray geoposArray, jdoubleArray attrArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isGeoposCopy, geoposArray, geopos)
    GET_DOUBLE_ARRAY_ELEMENTS(isAttrCopy, attrArray, attr)
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_sol_1eclipse_1when_1loc(JNIEnv *env, jclass swisseph, jdouble tjd_start,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_lun_1occult_1when_1loc(JNIEnv *env, jclass swisseph, jdouble tjd_start, jint ipl,
                                                   jobject starNameBuilder, jint ifl, jdoubleArray geoposArray,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_sol_1eclipse_1when_1glob(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_lun_1occult_1when_1glob(JNIEnv *env, jclass swisseph, jdouble tjd_start, jint ipl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_lun_1eclipse_1how(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint ifl,
                                              jdoubleArray geoposArray, jdoubleArray attrArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isGeoposCopy, geoposArray, geopos)
    GET_DOUBLE_ARRAY_ELEMENTS(isAttrCopy, attrArray, attr)
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_lun_1eclipse_1when(JNIEnv *env, jclass swisseph, jdouble tjd_start,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_lun_1eclipse_1when_1loc(JNIEnv *env, jclass swisseph, jdouble tjd_start,
                                                    jint ifl, jdoubleArray geoposArray, jdoubleArray tretArray,
                                                    jdoubleArray attrArray, jint backward, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isGeoposCopy, geoposArray, geopos)
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_pheno(JNIEnv *env, jclass swisseph, jdouble tjd, jint ipl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_pheno_1ut(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint ipl,
                                      jint iflag, jdoubleArray attrArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isCopy, attrArray, attr)
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_refrac(JNIEnv *env, jclass swisseph, jdouble inalt,
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_refrac_1extended(JNIEnv *env, jclass swisseph, jdouble inalt, jdouble geoalt,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1lapse_1rate(JNIEnv *env, jclass swisseph, jdouble lapse_rate) {
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_rise_1trans_1true_1hor(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint ipl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_rise_1trans(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint ipl,
                                        jobject starNameBuilder, jint epheflag, jint rsmi,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_nod_1aps(JNIEnv *env, jclass swisseph, jdouble tjd_et, jint ipl, jint iflag,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_nod_1aps_1ut(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jint ipl, jint iflag,
                                         jint method, jdoubleArray xnascArray, jdoubleArray xndscArray,
                                         jdoubleArray xperiArray, jdoubleArray xapheArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isCopy1, xnascArray, xnasc)
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_get_1orbital_1elements(JNIEnv *env, jclass swisseph, jdouble tjd_et, jint ipl,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_orbit_1max_1min_1true_1distance(JNIEnv *env, jclass swisseph, jdouble tjd_et,
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_deltat(JNIEnv *env, jclass swisseph, jdouble tjd) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_deltat_1ex(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_time_1equ(JNIEnv *env, jclass swisseph, jdouble tjd,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_lmt_1to_1lat(JNIEnv *env, jclass swisseph, jdouble tjd_lmt, jdouble geolon,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_lat_1to_1lmt(JNIEnv *env, jclass swisseph, jdouble tjd_lat, jdouble geolon,
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_sidtime0(JNIEnv *env, jclass swisseph, jdouble tjd_ut, jdouble eps, jdouble nut) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_sidtime(JNIEnv *env, jclass swisseph, jdouble tjd_ut) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1interpolate_1nut(JNIEnv *env, jclass swisseph, jint do_interpolate) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_cotrans(JNIEnv *env, jclass swisseph,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_cotrans_1sp(JNIEnv *env, jclass swisseph,
                                        jdoubleArray xpoArray, jdoubleArray xpnArray, jdouble eps) {
    GET_DOUBLE_ARRAY_ELEMENTS(isCopy1, xpoArray, xpo)
    GET_DOUBLE_ARRAY_ELEMENTS(isCopy2, xpnArray, xpn)
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_get_1tid_1acc(JNIEnv *env, jclass swisseph) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1tid_1acc(JNIEnv *env, jclass swisseph, jdouble t_acc) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_set_1delta_1t_1userdef(JNIEnv *env, jclass swisseph, jdouble dt) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_degnorm(JNIEnv *env, jclass swisseph, jdouble x) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_radnorm(JNIEnv *env, jclass swisseph, jdouble x) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_rad_1midp(JNIEnv *env, jclass swisseph, jdouble x1, jdouble x0) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_deg_1midp(JNIEnv *env, jclass swisseph, jdouble x1, jdouble x0) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_swelib_SwissEph_split_1deg(JNIEnv *env, jclass swisseph, jdouble ddeg, jint roundflag,
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_solcross(JNIEnv *env, jclass swephexp, jdouble x2cross, jdouble jd_et, jint flag, jobject errBuilder) {
    DEFINE_CHAR_SERR
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_mooncross(JNIEnv *env, jclass swephexp, jdouble x2cross, jdouble jd_et, jint flag, jobject errBuilder) {
    DEFINE_CHAR_SERR
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_mooncross_1ut(JNIEnv *env, jclass swephexp, jdouble x2cross, jdouble jd_ut, jint flag, jobject errBuilder) {
    DEFINE_CHAR_SERR
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_mooncross_1node(JNIEnv *env, jclass swephexp, jdouble jd_et, jint flag,
 ...
 */
JNIEXPORT jdouble JNICALL
Java_com_example_swelib_SwissEph_mooncross_1node_1ut(JNIEnv *env, jclass swephexp, jdouble jd_ut, jint flag,
                                                jdoubleArray xlonArray, jdoubleArray xlatArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isCopy1, xlonArray, xlon)
    GET_DOUBLE_ARRAY_ELEMENTS(isCopy2, xlatArray, xlat)
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_helio_1cross(JNIEnv *env, jclass swephexp, jint ipl, jdouble x2cross, jdouble jd_et,
 ...
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_helio_1cross_1ut(JNIEnv *env, jclass swephexp, jint ipl, jdouble x2cross, jdouble jd_ut,
                                             jint iflag, jint dir, jdoubleArray jdCrossArray, jobject errBuilder) {
    DEFINE_CHAR_SERR
    GET_DOUBLE_ARRAY_ELEMENTS(isCopy1, jdCrossArray, jd_cross)
...
/*
 * void convertBaziToDates(int32 yearGanZhi, int32 month, int32 dayGanZhi, int32 hour, double longitude, int32 rangeMin, int32 rangeMax, double *tjd_ut)
 *
 * Class:     swelib_SwissEph
 * Method:    convertBaziToDates
 * Signature: (IIIIDII[D)I
 */
JNIEXPORT jint JNICALL
Java_com_example_swelib_SwissEph_convertBaziToDates(JNIEnv *env, jclass swisseph, jint yearGanZhi,
                                                 jint month, jint dayGanZhi, jint hour, jdouble longitude,
                                                 jint rangeMin, jint rangeMax,
                                                 jdoubleArray tjd_ut) {
    GET_DOUBLE_ARRAY_ELEMENTS(isDblCopy, tjd_ut, result)
    int iflag = 258;
    int year_sq = yearGanZhi;
    int day_sq = dayGanZhi -1;
    int t_start = -7 + year_sq + (rangeMin / 60) * 60;

    int result_count = 0;
    for (int i = 0; i < 1000; i++) {
        int year_cal = t_start + i * 60;
        if (year_cal >= rangeMax) break;

        double t_lichun_earliest[2];
        swe_utc_to_jd(year_cal, 1, 28, 0, 0, 0, 2, t_lichun_earliest,NULL);

        double t0 = t_lichun_earliest[0] + (month - 1) * 30.436;
        double target_sun_lon_deg = fmod(285 + 30 * month, 360);
        double t_month_start = swe_solcross(target_sun_lon_deg, t0, iflag, NULL);
        double t_month_end = swe_solcross(fmod(target_sun_lon_deg + 30, 360), t_month_start + 25, iflag,NULL);

        double t_month_start_ut = t_month_start - swe_deltat_ex(t_month_start, 2, NULL);
        t_month_start_ut = t_month_start - swe_deltat_ex(t_month_start_ut, 2, NULL);
        double t_month_end_ut = t_month_end - swe_deltat_ex(t_month_end, 2, NULL);
        t_month_end_ut = t_month_end - swe_deltat_ex(t_month_end_ut, 2, NULL);

        double dGanZhi_start = fmod(t_month_start_ut - 0.5 + longitude / 360 + 15.0 / 360, 60);
        double dGanZhi_end = fmod(t_month_end_ut - 0.5 + longitude / 360 + 15.0 / 360, 60);

        double day_sq_start, day_sq_middle, day_sq_end;

        if (hour == 11) {
            day_sq_start = day_sq;
            day_sq_middle = day_sq + 0.5 / 12;
            day_sq_end = day_sq + 1.0 / 12;
        } else if (hour == 12) {
            day_sq_start = day_sq + 1.0 / 12;
            day_sq_middle = day_sq + 1.5 / 12;
            day_sq_end = day_sq + 2.0 / 12;
        } else {
            day_sq_start = day_sq + (hour + 1.0) / 12;
            day_sq_middle = day_sq + (hour + 1.5) / 12;
            day_sq_end = day_sq + (hour + 2.0) / 12;
        }

        if (dGanZhi_start < dGanZhi_end) {
            if (dGanZhi_start <= day_sq_middle && day_sq_middle <= dGanZhi_end) {
                result[result_count] = t_month_start_ut + day_sq_middle - dGanZhi_start;
                result_count++;
            } else if (dGanZhi_start <= day_sq_start && day_sq_start <= dGanZhi_end) {
                result[result_count] = t_month_start_ut + day_sq_start - dGanZhi_start;
                result_count++;
            } else if (dGanZhi_start <= day_sq_end && day_sq_end < dGanZhi_end) {
                result[result_count] = t_month_start_ut + day_sq_end - dGanZhi_start;
                result_count++;
            }
        } else {
            if (day_sq_middle > dGanZhi_start) {
                result[result_count] = t_month_start_ut + day_sq_middle - dGanZhi_start;
                result_count++;
            } else if (day_sq_middle <= dGanZhi_end) {
                result[result_count] = t_month_end_ut + day_sq_middle - dGanZhi_end;
                result_count++;
            } else if (day_sq_end > dGanZhi_start) {
                result[result_count] = t_month_start_ut + day_sq_end - dGanZhi_start;
                result_count++;
            } else if (day_sq_start <= dGanZhi_end) {
                result[result_count] = t_month_end_ut + day_sq_start - dGanZhi_end;
                result_count++;
            }
        }
    }
    RLZ_DOUBLE_ARRAY_ELEMENTS_OK(isDblCopy, tjd_ut, result)
    return result_count;
}